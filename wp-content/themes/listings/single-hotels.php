<?php
if (!isset($_GET['card']) && !isset($_GET['iframe']) && !isset($_GET['mobi']) && !isset($_GET['json'])) {
...
<div id="teloffer">
  ...
  <img src="http://essentialhotels.co.uk/wp-content/uploads/2014/03/Phone-Only-Deal-with-Offer-V4.png" alt="Special Phone Only Deals Call 0118 9714 700">
  </a>
</div>
...
<?php
      ...
      $booking_form = '<iframe width="310" scrolling="no" height="290" frameborder="0" align="middle" style="overflow: hidden;position: absolute; right: 6px; top: 10px; z-index: 4999;" allowtransparency="true" src="https://essentialhotels.co.uk/ota/out.php?doubleroom='. str_replace("http://$site/wp-content/uploads", "", get_post_meta($post->ID, 'classictwinroom', true)) 
...
<?php
  ...
  foreach ($post_types as $type) {
    ...
    case "destinations":
    case "hotels":
      $loop = new WP_Query( array( 'post_type' => $type, 'posts_per_page' => 100, 'paged' => $_GET['json'] )) ;
  ...
  include "/usr/home/customers/travelguide/www.essentialworld.travel/www/ota/inpage.php";
}
?>
